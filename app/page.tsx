    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black text-white">
      <header className="border-b border-purple-500/20 bg-black/40 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto p-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-yellow-400">⚔️ Крушители Подземелья</h1>
<nav className="flex gap-4 text-sm items-center">
  <Link href="/" className="hover:text-yellow-400 transition">Главная</Link>
  <Link href="/admin" className="hover:text-yellow-400 transition">👑 Админка</Link>
  <Link href="/auth" className="px-4 py-2 bg-yellow-500 hover:bg-yellow-400 text-black rounded font-bold transition">Войти</Link>
</nav>
        </div>
      </header>
